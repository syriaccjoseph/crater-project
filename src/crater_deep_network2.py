...
training_data, validation_data, test_data = network3.load_data_shared1()
mini_batch_size = 10
    ...
    for j in range(n):
        ...
        net = Network([
            ConvPoolLayer(image_shape=(mini_batch_size, 1, 200, 200),
                          ...
                          poolsize=(2, 2)),
            FullyConnectedLayer(n_in=20*88*88, n_out=100),
            SoftmaxLayer(n_in=100, n_out=2)], mini_batch_size)
        net.SGD(
            training_data, epochs, mini_batch_size, 0.2, validation_data, test_data)
    return net 
        ...
        for j in range(3):
            ...
            net = Network([
                ...
                ConvPoolLayer(image_shape=(mini_batch_size, 20, 98, 98),
                              ...
                              poolsize=(2, 2),
                              activation_fn=ReLU),
                FullyConnectedLayer(n_in=40*47*47, n_out=100, activation_fn=ReLU),
                SoftmaxLayer(n_in=100, n_out=2)], mini_batch_size)
